                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 mt-6">
                      <input
                        ...
                        className="block w-full sm:w-auto text-gray-300 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-2 file:border-blue-700 file:text-sm file:font-semibold file:bg-blue-900 file:text-blue-300 hover:file:bg-blue-800"
                      />
                      <Button
